...
drumKit.pads.forEach((pad) => {
	// Add class active to the pads on click
	pad.addEventListener("click", drumKit.activePad);
	// Remove animation so that it can receive animation again
...
// Add listener to all the Selects
// Run function to change the sound on each selection change
